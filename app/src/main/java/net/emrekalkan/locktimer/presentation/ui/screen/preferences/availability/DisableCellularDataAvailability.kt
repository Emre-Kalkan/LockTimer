...
class DisableCellularDataAvailability : PreferenceAvailability {
    override val actionType: TimerActionType
        get() = TimerActionType.PREF_DISABLE_CELLULAR_DATA
    ...
    override fun getPreferenceModel(): PreferenceModel<*> {
        return TimerActionPreferenceModel(key = actionType.key, titleRes = R.string.pref_title_disable_cellular_data)
    }
}